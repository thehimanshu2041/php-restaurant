        ...
        <div class="row" style="margin: 0px;background-color: #e75b1e">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="padding: 0px">
                <div id="reservation" class="about-main" style="margin: 0;">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2491.0112170006796!2d-0.12563048423521558!3d51.36609047961221!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487607eac2ac2171%3A0x68e8180e88f1103b!2sOh%20Spice!5e0!3m2!1sen!2sin!4v1614860855779!5m2!1sen!2sin"
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" style="padding: 0px">
                <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s"
                    style="padding: 30px; text-align: center; visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeIn; margin-top: 10%;">


                    <div class="contact_details">
                        <div class="contact_d_item">
                            <h3 class="block-title text-center" style="color:white !important;"><i
                                    class="fa fa-map-signs" aria-hidden="true"></i>&nbsp;&nbsp;Address :</h3>

                            <p style="color: black;">UNIT 25, 57a Croydon Rd, Croydon <br>CR0 4WQ, United Kingdom</p>
                        </div>
                        <div class="contact_d_item">
                            <h3 class="block-title text-center" style="color:white !important;"><i class="fa  fa-phone"
                                    aria-hidden="true"></i>&nbsp;&nbsp;Phone : <a href="tel:+44 7983630124">+44
                                    7983630124</a></h3>
                            <h3 class="block-title text-center" style="color:white !important;"><i
                                    class="fa  fa-envelope-o" aria-hidden="true"></i>&nbsp;&nbsp;Email : <a
                                    href="mailto:info@ohspice.co.uk">info@ohspice.co.uk</a></h3>
                        </div>
                        <div class="contact_d_item">
                            <h3 class="block-title text-center" style="color:white !important;"><i
                                    class="fa  fa-clock-o" aria-hidden="true"></i>&nbsp;&nbsp;Opening Hours :</h3>
                ...
                <div class="form-reservations-box">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <form id="aaaacontact-form" method="post" class="reservations-box">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-box">
                                    <input type="email" name="email" id="email" placeholder="E-Mail ID"
                                        data-error="E-mail id is required." required="required">
                                </div>
                            </div>
                            <!-- end col -->
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-box">
                                    <input type="text" pattern="\d{10}" size="10" maxlength="10" required="required"
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-box">
                                    <textarea name="message" id="message" class="textareainput" placeholder="Message"
