                ...
                <div class="banner-static">
                    <div class="banner-text">
                        <div class="banner-cell">
                            <h1>The taste that takes you back <span class="typer" id="some-id" data-delay="200"
                                    data-delim=":" data-words="Underneath:Homestyle Cooking"
    ...
    <div id="about" class="about-main">
        <div class="row" style="margin: 0px;background-color: #e75b1e">
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" style="padding: 0px">
                <div class="wow"
                    style="padding: 30px;text-align: center;visibility: visible;animation-duration: 1s;animation-delay: 0.1s;animation-name: fadeIn;margin-top: 15%;">
